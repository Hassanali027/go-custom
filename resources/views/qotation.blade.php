    ...
    <main class="main-content">
        ...
        <div class="iq-page-container">
            ...
            <div class="iq-page-sidebar" style="padding: 0; background: transparent; box-shadow: none;">
                <h2 style="font-family: 'Open Sans', sans-serif; font-size: clamp(1.1rem, 2.5vw, 1.5625rem); font-weight: 700; color: #000; margin-bottom: 1rem; margin-top: 0; white-space: nowrap;">Let's Build Your Perfect Box</h2>
